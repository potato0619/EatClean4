...
public class thucdondatabase extends SQLiteOpenHelper {
        private static  final String DATABASE_NAME = "QUANLYMONAN.db";
        private static  final String TABLE_NAME = "Monan";
        private static  final String TEN = "TEN";
        private static  final String MOTA = "MOTA";
        private static  final String CHITIET = "CHITIET";
        private Context context;

        public thucdondatabase (@Nullable Context myContext) {
        ...
        public void themNhanVien(MonAn MonanMoi,String table_name){
